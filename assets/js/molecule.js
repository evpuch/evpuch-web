...
function initMolecule() {
    ...
    const BLURBS = {
        ...
        music:   { title: 'On repeat', img: '/assets/images/music.jpg', text: "I'm a bit of a snob when it comes to emo music... ask me about Chicago-based screamo in the early 2010s. (Boy Problems at Dilly Dally Fest 2 — Underground Arts, Philadelphia, 2024, my favorite festival.)", link: { href: 'https://open.spotify.com/user/emilka.2006?si=2585f563cebe473e', label: 'My Spotify' } },
