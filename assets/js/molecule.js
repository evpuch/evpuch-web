...
function initMolecule() {
    ...
    const BLURBS = {
        core:    { title: 'Pigs, obviously', img: '/assets/images/pig.jpg', text: "I love pigs! They're very clean animals, but get a bad rep since they don't have sweat glands, hence their tendency to roll in mud. (A few of my pig stuffed animals from 2008 — I've always been a fan.)" },
        ...
        music:   { title: 'On repeat', img: '/assets/images/music.jpg', text: "I'm a bit of a snob when it comes to emo music... ask me about Chicago-based screramo in the early 2010s. (Boy Problems at Dilly Dally Fest 2 — Underground Arts, Philadelphia, 2024, my favorite festival.)", link: { href: 'https://open.spotify.com/user/emilka.2006?si=2585f563cebe473e', label: 'My Spotify' } },
        cars:    { title: 'Always bubbling', img: '/assets/images/ferment.jpg', imgPos: 'center 26%', text: "Devoted to fermentation. There's always a jar of something alive on my counter : kimchi, kraut, hot sauce, the list goes on. Letting microbes do the cooking is the closest thing to magic I know. (A jar of homemade pickles in Glacier National Park, my favorite park!!)" },
