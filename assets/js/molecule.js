...
function initMolecule() {
    ...
    const BLURBS = {
        ...
        music:   { title: 'On repeat', text: "I'm a bit of a snob when it comes to emo music... ask me about Chicago-based screramo in the early 2010s", link: { href: 'https://open.spotify.com/user/emilka.2006?si=2585f563cebe473e', label: 'My Spotify' } },
